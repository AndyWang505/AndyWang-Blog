...
description: 'SOLID 是一組通用的軟體設計原則，當系統規模不斷擴大時，維護和擴充的工作會越來越困難，而 SOLID 能引導開發者設計更靈活、更易於維護性與擴充性的軟體架構。'
...
SOLID 是一組通用的軟體設計原則，當系統規模不斷擴大時，維護和擴充的工作會越來越困難，而 SOLID 能引導開發者設計更靈活、更易於維護性與擴充性的軟體架構。
